...
swagger_template = {
    ...
    "info": {
        ...
        "version": "1.0.0",
        "title": "API 文档",
        "termsOfService": "https://github.com/FreakStudioCN/upypi.git",
        "contact": {
            "email": "10696531183@qq.com",
            "name": "FreakStudioCN",
            "url": "https://github.com/FreakStudioCN/"
        },
        "license": {
            "name": "AGPL-3.0",
            "url": "https://github.com/FreakStudioCN/upypi.git"
        }
    }
}
